...
In addition to fetching data using the Python REPL with an existing Client object, the code samples below show additional ways to fetch data from Discogs.
...
Data returns JSON including the URL to the page for the given release:
...
Formats returns JSON of the kind of release, such as CD, Vinyl, and any other special properties of the release:
...
`print(dir(d.release(20017387).tracklist))`
